...
//    }
    ...
    static func backgroundColor() -> UIColor {
        return UIColor.rgb(red: 0.979, green: 0.979, blue: 0.979)
    }
    
    static func textFieldColor() -> UIColor {
        return UIColor.rgb(red: 0.892, green: 0.892, blue: 0.892)
    }
    
    static func placeHolderColor() -> UIColor {
        return UIColor.rgb(red: 0.479, green: 0.479, blue: 0.479)
    }
    
    static func buttonColor() -> UIColor {
        return UIColor.rgb(red: 1, green: 0.667, blue: 0.298)
    }
}
